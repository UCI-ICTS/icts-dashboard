...
export const TABLE_MAPPING = [
  { name: "Metadata.Participants", schema: "participants", identifier: "participant_id" },
  { name: "Metadata.Families", schema: "families", identifier: "family_id" },
  { name: "Metadata.Genetic_Findings", schema: "genetic_findings", identifier: "genetic_findings_id" },
  { name: "Metadata.Analytes", schema: "analytes", identifier: "analyte_id" },
  { name: "Metadata.Biobank", schema: "biobank_entries", identifier: "biobank_id" },
  { name: "Metadata.Phenotypes", schema: "phenotypes", identifier: "phenotype_id" },
  { name: "Experiment.Experiment_DNA_Short_Read", schema: "experiment_dna_short_read", identifier: "experiment_dna_short_read_id" },
  { name: "Experiment.Experiment_RNA_Short_Read", schema: "experiment_rna_short_read", identifier: "experiment_rna_short_read_id" },
  { name: "Experiment.Experiment_Pac_Bio", schema: "experiment_pac_bio", identifier: "experiment_pac_bio_id" },
  { name: "Experiment.Experiment_Nanopore", schema: "experiment_nanopore", identifier: "experiment_nanopore_id" },
  { name: "Experiment.Aligned_DNA_Short_Read", schema: "aligned_dna_short_read", identifier: "aligned_dna_short_read_id" },
  { name: "Experiment.Aligned_Nanopore", schema: "aligned_nanopore", identifier: "aligned_nanopore_id" },
  { name: "Experiment.Aligned_Pac_Bio", schema: "aligned_pac_bio", identifier: "aligned_pac_bio_id" },
  { name: "Experiment.Aligned_RNA_Short_Read", schema: "aligned_rna_short_read", identifier: "aligned_rna_short_read_id" },
  { name: "Experiment.Aligned_DNA_Short_Read_Set", schema: "aligned_dna_short_read_set", identifier: "aligned_dna_short_read_set_id"},
  { name: "Experiment.Aligned_Nanopore_Set", schema: "aligned_nanopore_set", identifier: "aligned_nanopore_set_id" },
  { name: "Experiment.Aligned_Pac_Bio_Set", schema: "aligned_pac_bio_set", identifier: "aligned_pac_bio_set_id" },
  { name: "Experiment.Called_Variants_DNA_Short_Read", schema: "called_variants_dna_short_read", identifier: "called_variants_dna_short_read_id"},
  { name: "Experiment.Called_Variants_Nanopore", schema: "called_variants_nanopore", identifier: "called_variants_nanopore_id"},
  { name: "Experiment.Called_Variants_Pac_Bio", schema: "called_variants_pac_bio", identifier: "called_variants_pac_bio_id"},
];
