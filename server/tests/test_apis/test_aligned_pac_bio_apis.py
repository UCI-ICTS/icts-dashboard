...
class CreateAlignedPacBioAPITest(APITestCaseWithAuth):
    def test_create_aligned_pac_bio_api(self):
        ...
        aligned1 = {   # Existing entry, should fail
            ...
            "aligned_pac_bio_file": "gs://fc-secure-1b1e1ff4-3496-466f-8952-12f034c3c469/bam/pacbio/GREGoR_test-001-002-0.bam",
            "aligned_pac_bio_index_file": "gs://fc-secure-1b1e1ff4-3496-466f-8952-12f034c3c469/bam/pacbio/GREGoR_test-001-002-0.bai",
        ...
        aligned2 = {   # New entry
            "aligned_pac_bio_id": "UCI_GREGoR_test-002-002-2-R-2_PB-Aligned-2",
            "experiment_pac_bio_id": "UCI_GREGoR_test-002-002-2-R-2_PB",
            "aligned_pac_bio_file": "gs://fc-secure-1b1e1ff4-3496-466f-8952-12f034c3c469/bam/pacbio/GREGoR_test-002-002-2.bam",
            "aligned_pac_bio_index_file": "gs://fc-secure-1b1e1ff4-3496-466f-8952-12f034c3c469/bam/pacbio/GREGoR_test-002-002-2.bai",
        ...
        aligned3 =  {   # New entry
            "aligned_pac_bio_id": "UCI_GREGoR_test-003-002-1-R-2_PB-Aligned-2",
            "experiment_pac_bio_id": "UCI_GREGoR_test-003-002-1-R-2_PB",
        ...
        aligned1_exists = Aligned.objects.filter(
            pk="aligned_pac_bio.UCI_GREGoR_test-001-002-0-R-2_PB-Aligned-1"
        ).exists()
        assert aligned1_exists

        aligned2_exists = Aligned.objects.filter(
            pk="aligned_pac_bio.UCI_GREGoR_test-002-002-2-R-2_PB-Aligned-2"
        ).exists()
        ...
        aligned3_exists = Aligned.objects.filter(
            pk="aligned_pac_bio.UCI_GREGoR_test-003-002-1-R-2_PB-Aligned-2"
        ).exists()
...
class UpdateAlignedPacBioAPITest(APITestCaseWithAuth):
    def test_update_aligned_pac_bio_api(self):
        ...
        aligned2 = {  # Valid
            "aligned_pac_bio_id": "UCI_GREGoR_test-002-002-2-R-2_PB-Aligned-1",
            "experiment_pac_bio_id": "UCI_GREGoR_test-002-002-2-R-2_PB",
            "aligned_pac_bio_file": "gs://fc-secure-1b1e1ff4-3496-466f-8952-12f034c3c469/bam/pacbio/GREGoR_test-002-002-2.bam",
            "aligned_pac_bio_index_file": "gs://fc-secure-1b1e1ff4-3496-466f-8952-12f034c3c469/bam/pacbio/GREGoR_test-002-002-2.bai",
            "md5sum": "1e4020ccca6fe9c93c64747afa59eff1",
        ...
        aligned3 =  {  # Invalid, missing alignment_software
            "aligned_pac_bio_id": "UCI_GREGoR_test-003-002-1-R-2_PB-Aligned-1",
            "experiment_pac_bio_id": "UCI_GREGoR_test-003-002-1-R-2_PB",
            "aligned_pac_bio_file": "gs://fc-secure-1b1e1ff4-3496-466f-8952-12f034c3c469/bam/pacbio/GREGoR_test-003-002-1.bam",
            "aligned_pac_bio_index_file": "gs://fc-secure-1b1e1ff4-3496-466f-8952-12f034c3c469/bam/pacbio/GREGoR_test-003-002-1.bai",
            "md5sum": "727f9869058ef757cc3ff66503f1e036",
