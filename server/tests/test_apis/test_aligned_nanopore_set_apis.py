...
class DeleteAlignedNanoporeSetAPITest(APITestCaseWithAuth):
    def test_delete_nanopore_set_api(self):
        url = "/api/experiments/aligned_nanopore_set/create/"
        aligned = {"aligned_nanopore_set_id": "UCI_GREGoR_test-001-001-0-D-3_NANO_1-Aligned_1-SNV_2","aligned_nanopore_id": ["UCI_GREGoR_test-001-001-0-D-3_NANO_1-Aligned_1"]}
        url2 = "/api/experiments/aligned_nanopore_set/delete/?ids=UCI_GREGoR_test-001-001-0-D-3_NANO_1-Aligned_1-SNV_2,DNE-01-1"
