...
class UpdateRNAShortReadAPITest(APITestCaseWithAuth):
    def test_update_rna_short_read_api(self):
        ...
        experiment3["read_length"] = "150"

        response_200 = self.client.post(url, [experiment1], format="json")
        response_207 = self.client.post(url, [experiment3, experiment2], format="json")
...
class DeleteRNAShortReadAPITest(APITestCaseWithAuth):
    def test_delete_rna_short_read_api(self):
        ...
        self.assertEqual(response_400_1.data[0]["data"][:124],
                         '("Cannot delete some instances of model \'ExperimentRNAShortRead\' because they are referenced through protected foreign keys:')
        self.assertEqual(response_400_1.data[1]["data"], "Not found")


    def test_create_and_delete_rna_short_read_api(self):
        create_url = "/api/experiments/experiment_rna_short_read/create/"
        experiment2 = {
            "experiment_rna_short_read_id": "UCI_GREGoR_test-001-001-0-R-1_RNA_2",
            "analyte_id": "GREGoR_test-001-001-0-R-2",
            "experiment_sample_id": "UCI_GREGoR_test-001-001-0-R-1_RNA_1",
        ...
        create_response = self.client.post(create_url, [experiment2], format="json")
        ...
        delete_url = "/api/experiments/experiment_rna_short_read/delete/?ids=UCI_GREGoR_test-001-001-0-R-1_RNA_2"
