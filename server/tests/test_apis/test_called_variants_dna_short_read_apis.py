...
class ReadCalledVariantsDNAShortReadAPITest(APITestCaseWithAuth):
    def test_read_called_variants_dna_short_read(self):
        url1 = "/api/experiments/called_variants_dna_short_read/?ids=UCI_GREGoR_test-001-001-0-D-1_DNA_1-CalledVariants_1"
        url2 = "/api/experiments/called_variants_dna_short_read/?ids=UCI_GREGoR_test-002-001-2-D-1_DNA_1-CalledVariants_1, DNE-01-1"
...
class UpdateDNAShortReadAPITest(APITestCaseWithAuth):
    def test_update_called_variants_dna_short_read_api(self):
        ...
        called_variants1 = {  # Valid, added mean_coverage
            "called_variants_dna_short_read_id": "UCI_GREGoR_test-001-001-0-D-1_DNA_1-CalledVariants_1",
            "experiment_dna_short_read_id": "UCI_GREGoR_test-001-001-0-D-1_DNA_1",
            "called_variants_dna_short_read_file": "gs://fc-secure-3cbd4d3d-7331-46f9-a98f-ebba0a894562/cram/UCI_GREGoR_test-001-001-0-D-1_DNA_1-CalledVariants_1.cram",
            "called_variants_dna_short_read_index_file": "gs://fc-secure-3cbd4d3d-7331-46f9-a98f-ebba0a894562/cram/UCI_GREGoR_test-001-001-0-D-1_DNA_1-CalledVariants_1.crai",
            ...
            "analysis_details": "Raw reads were trimmed with fastp 0.23.2 and called_variants to GRCh38 (no alts) with bwa 0.7.17. Duplicates were marked and removed with GATK 4.3.0 MarkDuplicates, and BQSR was applied. Mean depth was computed with somalier 0.2.16.",
            "quality_issues": None,
        }

        called_variants2 = {  # Invalid, missing reference assembly, uri, and details
            "called_variants_dna_short_read_id": "UCI_GREGoR_test-002-001-2-D-1_DNA_1-CalledVariants_1",
...
class DeleteCalledVariantsDNAShortReadAPITest(APITestCaseWithAuth):
    def test_delete_dna_short_read_api(self):
        url2 = "/api/experiments/called_variants_dna_short_read/delete/?ids=UCI_GREGoR_test-001-001-0-D-1_DNA_1-CalledVariants_1, DNE-01-1"
