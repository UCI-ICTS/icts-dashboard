...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ("submodels", "0002_delete_alignedid_delete_experimentid"),
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to="submodels.internalprojectid",
                    ),
                ),
                (
                    "pmid_id",
        ...
        migrations.CreateModel(
            name="HistoricalGeneticFindings",
            fields=[
                ("created_at", models.DateTimeField(blank=True, editable=False)),
                ("updated_at", models.DateTimeField(blank=True, editable=False)),
                ("needs_review", models.BooleanField(default=False)),
            ...
            options={
                "verbose_name": "historical genetic findings",
                "verbose_name_plural": "historical genetic findingss",
                "ordering": ("-history_date", "-history_id"),
                "get_latest_by": ("history_date", "history_id"),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Whether the full pipeline is complete for this sample",
                    ),
                ),
                ("history_id", models.AutoField(primary_key=True, serialize=False)),
                ("history_date", models.DateTimeField(db_index=True)),
            ...
            options={
                "verbose_name": "historical Biobank Sample",
                "verbose_name_plural": "historical Biobank Samples",
                "ordering": ("-history_date", "-history_id"),
                "get_latest_by": ("history_date", "history_id"),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            options={
                "verbose_name": "historical analyte",
                "verbose_name_plural": "historical analytes",
                "ordering": ("-history_date", "-history_id"),
                "get_latest_by": ("history_date", "history_id"),
            },
            bases=(simple_history.models.HistoricalChanges, models.Model),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True,
                        help_text="Analyte extracted from this sample",
                        to="metadata.analyte",
                    ),
                ),
                (
