...
router.register(
    ...
    ExperimentRNAShortReadViewSet,
    basename="experiment_rna_short_read",
)
router.register(
    r"aligned_rna_short_read",
    AlignedRNAShortReadViewSet,
    basename="aligned_rna_short_read",
)
router.register(
    r"experiment_dna_short_read",
    ExperimentDNAShortReadViewSet,
    basename="experiment_dna_short_read",
)
router.register(
    r"aligned_dna_short_read",
    AlignedDNAShortReadViewSet,
